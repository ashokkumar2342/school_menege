    ...
    <div class="card h-100 shadow rounded-4 border-0 bg-white hover-shadow" style="transition: 0.3s ease;">
        <div class="card-body p-3 d-flex flex-column">
            ...
            <div class="mb-3 border border-light rounded" style="overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
                <iframe 
                    src="{{ url('pdfjs/web/viewer.html') }}?file={{ urlencode(route('admin.common.pdf.view', Crypt::encrypt('app/pdf/4/1/1/14062025154909.pdf'))) }}&disableDownload=true&disablePrint=true"
                    width="100%" 
                    height="700px" 
                    style="border: none;">
                </iframe>
            ...
            <div class="d-flex justify-content-between align-items-center mt-auto pt-2 border-top">
                {{-- View Button --}}
                <a href="{{ url('pdfjs/web/viewer.html') }}?file={{ urlencode(route('admin.common.pdf.view', Crypt::encrypt('app/pdf/4/1/1/14062025154909.pdf'))) }}&disableDownload=true&disablePrint=true" target="_blank" class="btn btn-sm btn-outline-dark rounded-pill me-2">
