...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Award Beneficiary Payment Detail</h3>
            </div>
            <div class="col-sm-6">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-3 form-group">
                    ...
                    <span class="fa fa-asterisk"></span>
                    <select name="award_detail" class="form-control select2" id="award_detail_select_box" onchange="callAjax(this,'{{ route('admin.common.awardDetailWiseAwardBeneficiaryDetail') }}','award_beneficiary_detail_select_box')" required>
                        <option selected disabled>Select Award Detail</option> 
                    </select>
                </div>
                <div class="col-lg-3 form-group">
                    <label for="exampleInputEmail1">Award Beneficiary Detail</label>
                    <span class="fa fa-asterisk"></span>
                    <select name="award_beneficiary_detail" class="form-control select2" id="award_beneficiary_detail_select_box" data-table-new-without-pagination="ajax_data_table" onchange="callAjax(this,'{{ route('admin.master.award.beneficiary.payment.table') }}','result_table')" required>
                        <option selected disabled>Select Award Beneficiary Detail</option> 
                    </select>
                </div>
            </div>             
        </div>
