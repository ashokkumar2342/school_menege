...
class ApiController extends Controller
{
    ...
    public function strem_video(Request $request)
    {
        try {
            ...
            $allowedHosts = ['manage.eageskool.com', '127.0.0.1', 'localhost', 'demo.eageskool.com', 'eduvia.eageskool.com', 'vpsjuniorrtk.eageskool.com', 'vsssrtk.eageskool.com', 'vpsrtk.eageskool.com', 'vgsssrtk.eageskool.com'];
